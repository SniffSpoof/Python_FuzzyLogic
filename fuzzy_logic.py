...
class fuzzy_set(object):
    def __init__(self, func_type="Empty", l=None, r=None, a=None, b=None, c=None, epsilon=1, u=None):
    ...
    def get_sup(self) -> set:
        return set(self.f)

    def alpha_cut(self, alpha) -> list[Union[Union[float, int], Any]]:
    ...
    def kvant(self, kvant_type, f2=None) -> None:
        if kvant_type == "not":
